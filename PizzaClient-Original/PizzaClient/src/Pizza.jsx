...
function Pizza() {
    ...
    useEffect(() => {
        ...
        const pizzaData = [
            { id: 1, name: 'Margherita', description: 'Tomato sauce, mozrella, and basil' },
    ...
    return (
        <div>
            <PizzaList name={term} data={data} onCreate={handleCreate} onUpdate={handleUpdate} onDelete={handleDelete} />
        </div>
    );
